...
class Logger(object):
    ...
    def set_names(self, names):
        ...
        self.numbers = {}
        self.names = names
        for _, name in enumerate(self.name):
    ...
    def plot(self, names=None, formats=None, x=None, xticks=None, ylim=None, grid=True,
             legend=True, xlabel=None, ylabel=None, title=None):
